...
export default function PhoneBlacklist({ schema, rows = [], pagination, routeUrl = '/admin/security/phone-blacklist', filterOptions = {} }) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader
                ...
                pageCode="1.13.1"
                subtitle={<button type="button" className="ps-guide-link" onClick={() => setGuideOpen(true)}>(xem hướng dẫn)</button>}
                actions={(
