    ...
    return (
        <AppLayout activeMenuCode={activeMenuCode}>
            ...
            <div className="ps-revenue-bonus-page">
                <div className="ps-revenue-bonus-header m-header-wrap">
                    <div className="ps-revenue-bonus-title"><span className="text">(UnitAdmin) Thiết lập tiền thưởng theo doanh số</span></div>
