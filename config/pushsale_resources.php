...
return [
    ...
    '5.3.1' => [
        ...
        'fields' => [
            ...
            ['key' => 'partner', 'label' => 'Nhà cung cấp', 'type' => 'text'],
            ...
            ['key' => 'note', 'label' => 'Ghi chú', 'type' => 'textarea'],
            ['key' => 'lines', 'label' => 'Dòng sản phẩm', 'type' => 'json'],
        ],
        'rules' => [
            'warehouse_id' => ['required', 'integer', 'exists:warehouses,id'],
            'code' => ['required', 'string', 'max:255'],
            'type' => ['required', 'in:inbound,outbound,internal,scrap'],
            'document_date' => ['nullable', 'date'],
            'partner' => ['nullable', 'string', 'max:255'],
            'product_id' => ['nullable', 'integer', 'exists:products,id'],
            'document_quantity' => ['nullable', 'integer', 'min:0'],
            ...
            'lines.*.document_quantity' => ['nullable', 'integer', 'min:0'],
            'lines.*.quantity' => ['required_with:lines', 'integer'],
            'lines.*.unit_cost' => ['nullable', 'integer', 'min:0'],
            'lines.*.batch_code' => ['nullable', 'string', 'max:255'],
            'lines.*.expiry_date' => ['nullable', 'date'],
            'lines.*.location_code' => ['nullable', 'string', 'max:255'],
