...
return [
    ...
    '1.9' => [
        ...
        'fields' => [
            ...
            ['key' => 'discount_value', 'label' => 'Giá trị chiết khấu', 'type' => 'currency', 'required' => true],
        ...
        'rules' => ['order_from' => ['required','integer','min:0'], 'discount_value' => ['required','integer','min:0'], 'calculation_type' => ['required','in:fixed,percent'], 'cod_from' => ['nullable','integer','min:0'], 'cod_to' => ['nullable','integer','min:0'], 'is_active' => ['boolean']],
    ],
    '1.13.1' => [
    ...
    '5.4' => [
        ...
        'fields' => [
            ...
            ['key' => 'carrier', 'label' => 'Đơn vị giao hàng', 'type' => 'text'],
            ['key' => 'order_count', 'label' => 'Số đơn', 'type' => 'number'],
            ['key' => 'product_count', 'label' => 'Số sản phẩm', 'type' => 'number'],
            ['key' => 'status', 'label' => 'Trạng thái', 'type' => 'select', 'options' => ['draft' => 'Nháp', 'confirmed' => 'Đã xác nhận', 'closed' => 'Đã đóng']],
            ['key' => 'note', 'label' => 'Ghi chú', 'type' => 'textarea'],
        ],
        'rules' => ['manager_user_id' => ['nullable','integer','exists:users,id'], 'name' => ['required','string','max:255'], 'document_date' => ['nullable','date'], 'carrier' => ['nullable','string','max:255'], 'order_count' => ['nullable','integer','min:0'], 'product_count' => ['nullable','integer','min:0'], 'status' => ['required','in:draft,confirmed,closed'], 'note' => ['nullable','string']],
    ],
    '6.2.1' => [
        'model' => Expense::class,
        'fields' => [
    ...
    '2.4.1' => [
        ...
        'fields' => [
            ['key' => 'name', 'label' => 'Tên nguồn kết nối', 'type' => 'text', 'required' => true],
            ['key' => 'marketer_user_id', 'label' => 'Marketing', 'type' => 'select', 'option_source' => 'marketers'],
            ['key' => 'product_id', 'label' => 'Sản phẩm', 'type' => 'select', 'option_source' => 'products'],
            ['key' => 'ad_channel', 'label' => 'Kênh quảng cáo', 'type' => 'select', 'options' => ['facebook' => 'Facebook ads', 'google' => 'Google ads', 'tiktok' => 'TikTok ads', 'youtube' => 'Youtube', 'other' => 'Khác']],
    ...
    '1.3.2' => [
        ...
        'rules' => ['name' => ['required','string','max:255'], 'sku' => ['nullable','string','max:255'], 'unit_price' => ['required','integer','min:0'], 'component_product_ids' => ['nullable','array'], 'component_product_ids.*' => ['integer','exists:products,id'], 'is_active' => ['boolean']],
        'defaults' => ['type' => 'combo'],
    ],
];
