...
return [
    ...
    'providers' => [
        ...
        'spx' => [
            ...
            'fields' => [
                'user_id' => ['label' => 'User ID', 'secret' => false, 'default' => env('SPX_USER_ID')],
                'secret_key' => ['label' => 'Secret Key', 'secret' => true, 'default' => env('SPX_SECRET_KEY')],
                'account_id' => ['label' => 'Account ID', 'secret' => false, 'default' => env('SPX_ACCOUNT_ID')],
                'api_version' => ['label' => 'API Version', 'secret' => false, 'default' => env('SPX_API_VERSION', 'v1')],
                'create_order_path' => ['label' => 'Path tạo đơn', 'secret' => false, 'default' => env('SPX_CREATE_ORDER_PATH')],
                'order_detail_path' => ['label' => 'Path tra cứu trạng thái', 'secret' => false, 'default' => env('SPX_ORDER_DETAIL_PATH')],
                'fee_path' => ['label' => 'Path tính phí', 'secret' => false, 'default' => env('SPX_FEE_PATH')],
                'cancel_order_path' => ['label' => 'Path hủy đơn', 'secret' => false, 'default' => env('SPX_CANCEL_ORDER_PATH')],
                'label_path' => ['label' => 'Path in nhãn', 'secret' => false, 'default' => env('SPX_LABEL_PATH')],
                'test_connection_path' => ['label' => 'Path test kết nối', 'secret' => false, 'default' => env('SPX_TEST_CONNECTION_PATH')],
                'signature_header' => ['label' => 'Header chữ ký', 'secret' => false, 'default' => env('SPX_SIGNATURE_HEADER', 'X-Signature')],
                'timestamp_header' => ['label' => 'Header timestamp', 'secret' => false, 'default' => env('SPX_TIMESTAMP_HEADER', 'X-Timestamp')],
            ],
        ],
    ],
];
