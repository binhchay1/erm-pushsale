...
class NavigationService
{
    ...
    private function adminNavigation(): array
    {
        return $this->grouped([
            ...
            $this->group('Báo cáo', [
                ...
                ['title' => 'Bảng tổng hợp chốt đơn', 'url' => '/admin/reports/extra/sale-2', 'icon' => 'table-2'],
                ['title' => 'Doanh số chi tiết sale', 'url' => '/admin/reports/extra/sale-3', 'icon' => 'trending-up'],
                ['title' => 'Sale KPI', 'url' => '/admin/reports/extra/sale-4', 'icon' => 'award'],
                ['title' => 'Lịch hẹn telesales', 'url' => '/admin/reports/extra/sale-5', 'icon' => 'calendar-clock'],
                ['title' => 'Doanh số marketing', 'url' => '/admin/reports/extra/marketing-1', 'icon' => 'circle-dollar-sign'],
                ['title' => 'Báo cáo chiến dịch', 'url' => '/admin/marketing/campaign-report', 'icon' => 'pie-chart'],
                ['title' => 'Tỉ lệ chốt đơn sản phẩm', 'url' => '/admin/reports/extra/marketing-2', 'icon' => 'percent'],
                ['title' => 'Doanh số theo kho', 'url' => '/admin/reports/extra/kho-1', 'icon' => 'store'],
                ['title' => 'Kinh doanh hệ thống', 'url' => '/admin/reports/extra/kho-2', 'icon' => 'landmark'],
            ]),
            $this->group('Marketing', [
                ['title' => 'Tổng quan Marketing', 'url' => '/admin/marketing/dashboard', 'icon' => 'megaphone'],
                ['title' => 'Duyệt trang Landing', 'url' => '/admin/landing-approvals', 'icon' => 'layout-template'],
            ]),
            $this->group('Telesale', [
                ['title' => 'Nhật ký lead về', 'url' => '/admin/leads', 'icon' => 'inbox'],
            ]),
            ...
            $this->group('Kho & Tài chính', [
                ...
                ['title' => 'Lịch sử nhập xuất kho', 'url' => '/admin/warehouse/movements', 'icon' => 'arrow-right-left'],
    ...
    private function salesItems(): array
    {
        return [
            ...
            ['title' => 'Báo cáo nghiệp vụ', 'url' => '/sales/reports/sale-1', 'icon' => 'file-bar-chart'],
            ['title' => 'Xếp hạng doanh thu', 'url' => '/sales/rankings', 'icon' => 'trophy'],
            ['title' => 'Hồ sơ khách hàng', 'url' => '/sales/customers', 'icon' => 'book-user'],
            ['title' => 'Sơ đồ nhân sự', 'url' => '/org-chart', 'icon' => 'git-branch'],
            ['title' => 'Cài đặt', 'url' => '/settings', 'icon' => 'settings'],
        ];
    }
    ...
    private function marketingItems(): array
    {
        return [
            ...
            ['title' => 'Báo cáo nguồn quảng cáo', 'url' => '/marketing/workspace', 'icon' => 'share2'],
            ['title' => 'Báo cáo chiến dịch', 'url' => '/marketing/campaign-report', 'icon' => 'pie-chart'],
            ['title' => 'Trang Landing', 'url' => '/marketing/campaigns', 'icon' => 'layout-template'],
            ['title' => 'Báo cáo doanh số', 'url' => '/marketing/revenue', 'icon' => 'trending-up'],
            ['title' => 'Báo cáo nghiệp vụ', 'url' => '/marketing/reports/marketing-1', 'icon' => 'file-bar-chart'],
    ...
    private function warehouseItems(User $user): array
    {
        ...
        if ($user->is_team_leader || in_array($user->org_level, [OrgLevel::Head, OrgLevel::Supervisor], true)) {
            $items[] = ['title' => 'Báo cáo kho', 'url' => '/warehouse/reports/kho-1', 'icon' => 'chart-area'];
        }
    ...
    private function accountingItems(): array
    {
        return [
            ...
            ['title' => 'Báo cáo kinh doanh', 'url' => '/accounting/reports/kho-1', 'icon' => 'receipt'],
            ['title' => 'Sơ đồ nhân sự', 'url' => '/org-chart', 'icon' => 'git-branch'],
            ['title' => 'Cài đặt', 'url' => '/settings', 'icon' => 'settings'],
        ];
    }
    ...
    private function allocatorItems(): array
    {
        return [
            ...
            ['title' => 'Chia số cho sale', 'url' => '/allocator/workspace', 'icon' => 'user-plus'],
            ['title' => 'Sơ đồ nhân sự', 'url' => '/org-chart', 'icon' => 'git-branch'],
            ['title' => 'Cài đặt', 'url' => '/settings', 'icon' => 'settings'],
        ];
    }
