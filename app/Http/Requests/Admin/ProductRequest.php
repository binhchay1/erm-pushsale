...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'marketing_team_ids' => ['sometimes', 'array'],
            'marketing_team_ids.*' => ['integer', 'distinct', 'exists:teams,id'],
            'marketing_user_ids' => ['sometimes', 'array'],
            'marketing_user_ids.*' => ['integer', 'distinct', 'exists:users,id'],
            'sale_team_ids' => ['sometimes', 'array'],
            'sale_team_ids.*' => ['integer', 'distinct', 'exists:teams,id'],
            'sale_user_ids' => ['sometimes', 'array'],
            'sale_user_ids.*' => ['integer', 'distinct', 'exists:users,id'],
            'care_team_ids' => ['sometimes', 'array'],
            'care_team_ids.*' => ['integer', 'distinct', 'exists:teams,id'],
            'care_user_ids' => ['sometimes', 'array'],
            'care_user_ids.*' => ['integer', 'distinct', 'exists:users,id'],
