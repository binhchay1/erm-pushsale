...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'delivery_status', 'warehouse_care_status', 'warehouse_care_note', 'warehouse_care_user_id', 'warehouse_care_updated_at', 'printed_at', 'return_reason', 'return_restocked_at',
    ...
    protected function casts(): array
    {
        return [
            ...
            'printed_at' => 'datetime',
            'warehouse_care_updated_at' => 'datetime',
