...
{
    protected $fillable = [
        'name', 'partner_type', 'endpoint_url', 'access_token', 'public_token',
        'marketing_source_id', 'landing_connection_id', 'marketer_user_id', 'product_id',
        'ad_channel', 'sale_priority', 'manual_import', 'is_approved', 'is_active',
