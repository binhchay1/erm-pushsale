...
return [
    ...
    'lead_intake' => [
        ...
        'late_upsell_review' => 'Upsell đến sau cửa sổ :seconds giây của đơn :code. Hệ thống không gộp và không chia sale lại; cần sale/điều phối kiểm tra.',
        'orphan_upsell_review' => 'Đã nhận gói upsell nhưng chưa tìm thấy form/đơn gốc trong cửa sổ 90 giây. Gói tin được giữ lại để kiểm tra, không tự tạo đơn.',
        'upsell_merged_history' => 'Hệ thống đã gộp sản phẩm upsell vào đơn trong cửa sổ cho phép.',
        'late_upsell_history' => 'Hệ thống nhận upsell sau khi cửa sổ gộp đã đóng; chưa thay đổi đơn.',
        'not_reviewable' => 'Gói tin này không thuộc hàng chờ kiểm tra.',
        'review_forbidden' => 'Bạn không có quyền xử lý gói mua thêm này.',
        'review_marked' => 'Đã xử lý gói tin cần kiểm tra.',
        'invalid_review_resolution' => 'Cách xử lý gói tin không hợp lệ.',
        'related_order_missing' => 'Không tìm thấy đơn gốc liên quan đến gói upsell.',
        'order_no_longer_mergeable' => 'Đơn :code đã chốt, xuất kho hoặc tạo vận đơn nên không thể gộp an toàn. Hãy tạo đơn bổ sung hoặc bỏ qua.',
        'upsell_has_no_items' => 'Gói upsell không có sản phẩm hợp lệ để xử lý.',
        'review_merge_history' => 'Người vận hành đã duyệt và gộp thủ công gói upsell đến muộn vào đơn.',
    ...
    'sale_ops' => [
        ...
        'order_locked' => 'Đơn đang được người khác thao tác. Vui lòng đợi rồi thử lại.',
    ],
    'shipping_actions' => [
        ...
        'waybill_failed' => 'Không tạo được vận đơn. Kiểm tra PTGH / cấu hình NetShip rồi thử lại.',
        ...
        'netship_shop_id_required' => 'Thiếu Shop ID NetShip — cấu hình theo kho (tab NetShip) hoặc Shop ID mặc định ở Đối tác vận chuyển.',
