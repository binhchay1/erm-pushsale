...
Route::redirect('pages/2-4-2-ket-noi-du-lieu', '/admin/marketing/website-connections?connection_type=website&per_page=20', 301);
Route::redirect('marketing/facebook-source', '/admin/marketing/website-connections?connection_type=website&per_page=20', 301);
Route::redirect('ld/facebook/tao-nguon-du-lieu', '/admin/marketing/website-connections?connection_type=website&per_page=20', 301);
Route::get('marketing/facebook/connect', [\App\Http\Controllers\Admin\Marketing\FacebookConnectController::class, 'connect'])->name('marketing.facebook.connect');
Route::post('marketing/facebook/connect/sync', [\App\Http\Controllers\Admin\Marketing\FacebookConnectController::class, 'sync'])->name('marketing.facebook.connect.sync');
Route::get('marketing/facebook/posts', [\App\Http\Controllers\Admin\Marketing\FacebookConnectController::class, 'posts'])->name('marketing.facebook.posts');
Route::post('marketing/facebook/posts/sync', [\App\Http\Controllers\Admin\Marketing\FacebookConnectController::class, 'syncPosts'])->name('marketing.facebook.posts.sync');
Route::patch('marketing/facebook/posts/{post}', [\App\Http\Controllers\Admin\Marketing\FacebookConnectController::class, 'updatePost'])->whereNumber('post')->name('marketing.facebook.posts.update');
Route::redirect('ld/facebook/ket-noi', '/admin/marketing/facebook/connect', 301);
Route::redirect('ld/facebook/quan-ly', '/admin/marketing/facebook/connect', 301);
Route::redirect('ld/facebook/danh-sach-post', '/admin/marketing/facebook/posts', 301);
Route::redirect('pages/2-5-1-tao-nguon-du-lieu', '/admin/marketing/website-connections?connection_type=website&per_page=20', 301);
Route::redirect('pages/2-5-2-ket-noi-fanpage-facebook', '/admin/marketing/facebook/connect', 301);
Route::redirect('pages/2-5-3-danh-sach-bai-post-facebook', '/admin/marketing/facebook/posts', 301);
